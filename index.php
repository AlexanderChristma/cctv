    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        session_start();
         if (isset($_POST['submit'])) {
             ...
             || empty($repass) || !isset($country) || !isset($gender) || $file['error']==4) {
        ...
        <input type="text" class="input" name="phone" Placeholder=" Enter Phone Number"> <br>
        <input type="password" class="input" name="password" Placeholder=" Enter Password"> <br>
        <input type="password" class="input" name="repass" Placeholder="Repeat Password"> <br>
